...
const ProfileRetrieveComponent = ({ Redux }) => {
  ...
  return (
    <React.Fragment>
      <section class="bg-[#FAEBEF] dark:bg-[#333D79] text-[#333D79] dark:text-[#FAEBEF] lg:px-20">
          ...
          <div class="lg:w-4/6 mx-auto">
            ...
            <div class="flex flex-col sm:flex-row mt-10">
              <div class="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                <div class="w-20 h-20 rounded-full inline-flex items-center justify-center bg-[#333D79] dark:bg-[#FAEBEF] text-[#FAEBEF] dark:text-[#333D79]">
                ...
                <div class="flex flex-col items-center text-center justify-center">
                  ...
                  <div class="w-12 h-1 bg-[#333D79] dark:bg-[#FAEBEF] rounded mt-2 mb-4"></div>
                  <p class="text-base">{Redux.state.ReceivedObject?.Retrieve?.subtitle}</p>
                </div>
              </div>
              <div class="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-[#333D79] dark:border-[#FAEBEF] sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
        ...
        <div class="container px-5 py-12 mx-auto">
          <div class="flex flex-wrap -m-4">
            ...
            <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div class="h-full p-6 rounded-lg border border-[#333D79] dark:border-[#FAEBEF] flex flex-col relative overflow-hidden">
                <h1 class="text-2xl pb-4 mb-4 border-b border-[#333D79] dark:border-[#FAEBEF] leading-none">Critical Information</h1>
            ...
            <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div class="h-full p-6 rounded-lg border border-[#333D79] dark:border-[#FAEBEF] flex flex-col relative overflow-hidden">
                <h1 class="text-2xl pb-4 mb-4 border-b border-[#333D79] dark:border-[#FAEBEF] leading-none">Basic Information</h1>
            ...
            <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div class="h-full p-6 rounded-lg border border-[#333D79] dark:border-[#FAEBEF] flex flex-col relative overflow-hidden">
                <h1 class="text-2xl pb-4 mb-4 border-b border-[#333D79] dark:border-[#FAEBEF] leading-none">Relation Information</h1>
            ...
            <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div class="h-full p-6 rounded-lg border border-[#333D79] dark:border-[#FAEBEF] flex flex-col relative overflow-hidden">
                <h1 class="text-2xl pb-4 mb-4 border-b border-[#333D79] dark:border-[#FAEBEF] leading-none">More Information</h1>
